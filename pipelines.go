...
type Pipeline struct {
	...
	ExecutionEngine      string                   `json:"executionEngine,omitempty" yaml:"executionEngine,omitempty"`
	Parallel             bool                     `json:"parallel" yaml:"parallel"`
	LimitConcurrent      bool                     `json:"limitConcurrent" yaml:"limitConcurrent"`
	KeepWaitingPipelines bool                     `json:"keepWaitingPipelines" yaml:"keepWaitingPipelines"`
	Stages               []map[string]interface{} `json:"stages,omitempty" yaml:"stages,omitempty"`
	Triggers             []map[string]interface{} `json:"triggers,omitempty" yaml:"triggers,omitempty"`
	Parameters           []map[string]interface{} `json:"parameterConfig,omitempty" yaml:"parameterConfig,omitempty"`
	Notifications        []map[string]interface{} `json:"notifications,omitempty" yaml:"notifications,omitempty"`
	ExpectedArtifacts    []map[string]interface{} `json:"expectedArtifacts,omitempty" yaml:"expectedArtifacts,omitempty"`
	...
	UpdateTs             string                   `json:"updateTs" yaml:"updateTs"`
	Locked               PipelineLockType         `json:"locked,omitempty" yaml:"locked,omitempty"`
}

type PipelineLockType struct {
	UI            bool `json:"ui" yaml:"ui"`
	AllowUnlockUI bool `json:"allowUnlockUi" yaml:"allowUnlockUi"`
}
